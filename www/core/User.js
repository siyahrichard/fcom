...
User.parseArray=function(obj)
{
	
};
User.flag=function(loginName,prefix)
{
	
};
User.checkFlag=function(loginName)
{
	
};
User.findServer=function(loginName)
{
...
User.verify=function(userData)
{
	
};
User.getCert=function(loginName,uid,apsi,lang,network,domain)
{
...
User.updateLogin=function(uid,username,email,phone,country)
{
	
};
User.setLookupee=function(fp,uid)
{
...
User.expireLookupee=function(fp)
{
